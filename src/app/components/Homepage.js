...
>
  ...
  <div className="mx-auto mt-10 max-w-xl">
    ...
    <section
  id="projectspage"
  className="mx-auto lg:w-4/5 w-full px-6 py-16 text-[#EDEDED]"
>
  {/* divider */}
  ...
  <div className="text-center">
    ...
    <p className="mt-4 mx-auto max-w-2xl font-mont text-[#DADADA] leading-relaxed">
      A selection of work focused on clarity, reliability, and useful outcomes.
    </p>
  </div>

  {/* Data-driven projects (easy to add/remove later) */}
  {(() => {
    const projects = [
      {
        title: "MindCere",
        description:
          "A brain health and self-improvement project built to explore information, routine, and practical insights.",
        image: "/images/mindcere-pic.png",
        tools: "Next.js · FastAPI · MongoDB Atlas · AWS EC2 · OpenAI API",
        live: "https://www.mindcere.com",
        source: null, // add later if you want
      },
      {
        title: "Bus Map Road API",
        description:
          "Maps Halifax Transit data with frequent updates, using Leaflet for dynamic mapping and live display.",
        image: "/images/busmapimage.png",
        tools: "JavaScript · Leaflet · Halifax Transit API",
        live: "https://cameronhilliard.github.io/busmapapi/",
        source: "https://cameronhilliard.github.io/busmapapi/",
      },
    ];
        ...
        {projects.map((p) => (
          <article
            ...
            className="
              rounded-2xl border border-[#EDEDED]/10 bg-[#0F0F10]
              overflow-hidden
              transition hover:border-[#C86A2A]/30
            "
          >
            {/* image */}
            <div className="relative">
              ...
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#0F0F10]/70 via-transparent to-transparent" />
            </div>

            {/* content */}
            <div className="p-6">
              <h3 className="font-mont text-lg sm:text-xl font-medium tracking-wide text-[#EDEDED]">
                {p.title}
              </h3>

              <p className="mt-3 font-mont text-sm leading-relaxed text-[#DADADA]">
                {p.description}
              </p>

              {/* tools line (small, premium) */}
              <p className="mt-5 font-mont text-xs tracking-[0.25em] text-[#DADADA]/60">
                TOOLS
              </p>
              <p className="mt-2 font-mont text-sm text-[#DADADA]">
                {p.tools}
              </p>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link
                  ...
                  className="
                    ...
                    bg-[#C86A2A] px-5 py-2.5
                    font-mont text-sm tracking-wide
                    text-[#0F0F10] hover:opacity-90 transition
                  "
                >
                  Live Demo
                </Link>
                ...
                {p.source && (
                  <Link
                    ...
                    className="
                      inline-flex items-center justify-center rounded-xl
                      border border-[#C86A2A]/40 px-5 py-2.5
                      font-mont text-sm tracking-wide
                      text-[#EDEDED] hover:bg-[#C86A2A]/10 transition
                    "
                  >
                    Source
                  </Link>
