...
const Homepage = () => {
  ...
  return (
  <>
  <section id="homepage" className='text-white py-32'>
...
{/*     
    ...
    <section id="aboutpage" className="lg:w-2/3 md:w-4/5py-24 p-6 text-white mx-auto">
      <h2 className="text-3xl font-mont font-semibold text-accent">About Me</h2>
      <p className="mt-4 lg:text-2xl lg:max-w-full md:max-w-2xl text-lg font-mont text-accent dark:text-white">I'm passionate about automating tasks and creating digital solutions to streamline everyday processes. By combining my skills in full-stack development and problem-solving, I aim to build efficient systems that save time and improve productivity.I'm passionate about automating tasks and creating digital solutions to streamline everyday processes. By combining my skills in full-stack development and problem-solving, I aim to build efficient systems that save time and improve productivity.</p>
    </section>


    <section id="skillspage" className="lg:w-2/3 md:w-4/5 p-6 py-24 text-white mx-auto  ">
      <h2 className="text-3xl font-mont font-semibold dark:text-accent text-accent">Skills</h2>
      <div className='lg:grid lg:grid-cols-5 lg:grid-rows-6 md:grid md:grid-cols-3 grid grid-cols-3'>
      ...
      <div className='lg:col-start-3 p-2 md:p-0  mx-auto'>
      <Image 
          src={"/images/js.png"}
          width={90}
          height={80}
      ...
      <div className='lg:col-start-4 mx-auto md:p-0  p-2 mt-8'>
      <Image 
      ...
      <div className='lg:col-start-2 lg:row-start-2 md:p-0  p-2 mx-auto mt-8'>
      <Image 
      ...
      <div className='lg:col-start-3 col-start-2 row-start-2 mx-auto '>
      <Image  
      ...
      <Image  
          ...
          alt='MongoDB Logo'
        />
        <p className='mx-auto p-2  text-center font-mont'>Tailwind</p>
      </div>
      </div>
    </section>
    </>
